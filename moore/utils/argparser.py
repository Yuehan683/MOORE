...
def argparser():
    ...
    arg_me.add_argument("--diag_canon_sign", action="store_true",
                        help="Diagnostics only. Recorded in diagnostics only; does not change GS forward.")
    arg_me.add_argument("--diag_rank_tol", type=float, default=1e-6,
                        help="Diagnostics only. Used for rank-failure logging, not for GS forward computation.")
    ...
    arg_utils.add_argument("--save_diagnostics", action="store_true",
                           help="Save orthogonality and stability diagnostics as .npy files.")
    arg_utils.add_argument("--log_diagnostics", action="store_true",
                           help="Log diagnostics to wandb.")
